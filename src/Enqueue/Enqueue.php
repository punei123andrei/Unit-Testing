...
class Enqueue
{
     ...
     * @return $this
     */
    public function addScript(string $handle, string $src = '', array $deps = [], ?string $ver = null, bool $inFooter = false): Enqueue
    {
        $this->actionEnqueueScripts(function () use ($handle, $src, $deps, $ver, $inFooter) {
 ...
 * @return Enqueue
 */
    public function localizeScript(string $handle, string $src = '', array $deps = [], ?string $ver = null, bool $inFooter = false): Enqueue
    {
